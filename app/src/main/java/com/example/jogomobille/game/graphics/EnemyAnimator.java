...
public class EnemyAnimator {
    ...
    public void draw(Canvas canvas, GameDisplay gameDisplay, Teraculos enemy) {
        updatesBeforeNMF--;
    ...
    public void drawFrame(Canvas canvas, GameDisplay gameDisplay, Teraculos enemy, Sprite sprite){
        sprite.draw(
                canvas,
